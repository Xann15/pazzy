...
class MessagesController extends Controller
{
    ...
    {
        // Daftar kata kasar yang ingin disensor
        $badWords = [
            ...
            // Kata Toxic dalam Bahasa Inggris
            "fuck",
            "shit",
            "asshole",
            "bastard",
            ...
            // Variasi Ejaan dan Slang (Bahasa Indonesia)
            "anjir",
            "anjas",
            "bngst",
            "bgst",
            ...
            // Variasi Ejaan dan Slang (Bahasa Inggris)
            "fck",
            "sh1t",
            "a55hole",
            "b@stard",
        ...
        $replacement = '<censored>$0</censored>'; // Menyensor kata kasar
        ...
        // Proses pesan jika tidak ada error
        if (!$error->status) {
            $messageText = htmlentities(trim($request->message), ENT_QUOTES, 'UTF-8');

            // Cek dan sensorkan kata kasar
            $messageText = preg_replace('/\b(' . implode('|', $badWords) . ')\b/i', $replacement, $messageText);
            ...
            // Parse pesan untuk tampilan
            $messageData = Chatify::parseMessage($message);

            // Kirim notifikasi ke penerima menggunakan Pusher
        ...
        return Response::json([
            ...
            'message_id' => $message->id ?? null, // Pastikan ID dikirim
            'tempID' => $request['temporaryMsgId'],
        ]);
    }
