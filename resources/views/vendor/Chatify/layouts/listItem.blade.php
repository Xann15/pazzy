...
@if ($get == 'users' && !!$lastMessage)
    ...
    if ($lastMessageBody) {
        $lastMessageBody = str_replace('<censored>', '<span class="censored">', $lastMessageBody);
        $lastMessageBody = str_replace('</censored>', '</span>', $lastMessageBody);
    }
    ?>
    <table class="messenger-list-item" data-contact="{{ $user->id }}">
        <tr data-action="0">
            ...
            <td>
                ...
                <span class="log-typing">Typing...</span>
